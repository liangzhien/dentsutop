...
class SaeImage extends SaeObject 
{
     ...
     *       支持的字体：SAE_SimSun(宋体,默认)、SAE_SimKai(楷体)、SAE_SimHei(正黑)、SAE_MicroHei(微米黑)、SAE_Arial
     *     weight,字体宽度,int
     *     size，字体大小,int
     ...
     * @return mixed 若设置$display为true，返回void，否则返回图片二进制数据。失败时返回false
     * @author Lijun
     */
